...
**If you have a Skill tool available**: Use it directly with `skill: "skill-creator"` instead of reading the file manually.

**Otherwise**:
1. Read the skill file at this exact path: `~/.claude/skills/skill-creator/SKILL.md`
