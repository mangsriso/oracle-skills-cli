---
description: v3.0.4 | Pre-plan knowledge integration. Use when user says "prepare", "prep for plan", or before starting plan mode on non-trivial work. Combines oracle protection + internal discovery + learn docs + gap analysis. Do NOT use for quick fixes or trivial tasks.
---
